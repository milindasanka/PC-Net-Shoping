$(document).ready(function(){
					...
					if (productList) {
						$.each(resp.message.products, function(index, value){
							...
							productHTML += '<tr>'+
								              ...
								              '<td><img width="60" height="60" src="C:/xampp/htdocs/pcnet/images/'+value.product_image+'"></td>'+
	...
	$(document.body).on('click', '.edit-product', function(){
		...
		$("input[name='e_product_image']").siblings("img").attr("src", "C:/xampp/htdocs/pcnet/images/"+product.product_image);
